...
| `docs/MODEL_ROUTING_STRATEGY.md` | `gemini-2.0-flash-live-001`, `gemini-2.0-flash` fallbacks | Rewrite docs | Standardize around the new mandated models |
| `docs/ENVIRONMENT.md` | `gemini-2.0-flash-exp` (deprecated) | Delete old exp ref | Update references |
| `docs/AI_AND_LIVE_SYSTEM_AUDIT.md`| `gemini-2.0-flash-live-001` | Rewrite docs | Standardize around the new mandated models |
| `docs/CLOUD_RUN_DEPLOY.md` | `gemini-2.0-flash-live-001` | Update CLI flags | Standardize around the new mandated models |
| `docs/AI_FAILURE_AND_FALLBACKS.md`| `gemini-2.0-flash` fallback | Update fallback docs | Standardize around the new mandated models |
| `docs/LIVE_MESSAGE_FLOW.md` | `gemini-2.0-flash-live-001` | Update WS init string | Standardize around the new mandated models |
